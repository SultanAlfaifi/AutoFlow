...
- When an ordered action should run only if the remaining balance is above a stated threshold, set that action's safety.balanceAboveOn=true and safety.balanceAbove to the exact threshold. This is a supported per-action precondition evaluated after earlier ordered outflows and before the current action.
